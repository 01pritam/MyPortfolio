...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen text-cyan-50 py-12 px-4">
            ...
            <div className="md:w-1/2 p-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={prevProject}
                    className="p-2 rounded-full bg-gray-500 hover:bg-gray-200 transition-colors"
                  >
            ...
            {testimonials.map((project, index) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <h4 className="font-bold text-gray-900 mt-1 mb-2">
                    {project.name}
                  </h4>
                  <p className="text-gray-600 text-sm line-clamp-3">{project.quote}</p>
                </div>
              </div>
            ))}
          </div>
